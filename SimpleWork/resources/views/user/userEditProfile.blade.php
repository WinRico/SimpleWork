...
@section('title_name')Редагування інформації користувача@endsection
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" value="{{$getRecord->firstname}}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" value="{{$getRecord->lastname}}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" value="{{$getRecord->email}}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                    <h6 class="mb-0">Працює з </h6>
                                </div>
                                <div class="col-sm-3">
                                    <h6 type="text" lass="mb-0"> {{$getRecord->date_coming->format('Y-m-d')}}</h6>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-3"></div>
                                <div class="col-sm-9 text-secondary">
                                    <input type="button" class="btn btn-primary px-4" value="Зберегти зміни">
                                </div>
                            </div>
                        </div>
                    </div>
